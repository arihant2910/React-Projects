...
import rockImage from "F:/react projects/rps/src/zoltan-tasi-QxjEi8Fs9Hg-unsplash.jpg"
import scissorsImage from "F:/react projects/rps/src/scissors.jpg";
import paperImage from "F:/react projects/rps/src/paper.jpg"
        ...
        return(
            <div className="container">
                ...
                <div >
                    ...
                    <img src={rockImage} alt="ROCK" width="50" height="60"/>
                        <i className={`fas fa-hand-rock`} /> 
                    </button>
                    <button onClick={()=>this.decision("PAPER")}>
                    <img src={paperImage} alt="ROCK" width="50" height="60"/>
                        <i className={`fas fa-hand-paper`} /> 
                    </button>
                    <button onClick={()=>this.decision("SCISSORS")}>
                    <img src={scissorsImage} alt="ROCK" width="50" height="60"/>
